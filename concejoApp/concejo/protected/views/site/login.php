...
<form action="index.php?r=site/login" method="POST" id="login-form">
			...
			<div style='float:right'><small ><small><i>Recomendaciones para el sistema</i></small></small> <a target='_blank' href='http://www.mozilla.org/'> <img src='images/firefox.jpg'/> </a> <a target='_blank' href='http://www.google.com/chrome?hl=es'><img src='images/chrome.jpg'/></a></div>
			<br/><br/><div class="information-box round">En caso de no tener acceso por favor, enviar un mail a <a href="mailto:alejandro@softer.com.ar">alejandro@softer.com.ar</a></div>
